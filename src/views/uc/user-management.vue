    ...
    >
      ...
      /></el-form-item> -->
        <el-form-item prop="username" required label="用户名">
          <el-input v-model="dialogConfig.formData.username" />
        </el-form-item>
        <el-form-item prop="nickName" required label="昵称">
          <el-input v-model="dialogConfig.formData.nickName" />
        </el-form-item>
        <el-form-item prop="phone" required label="电话">
          <el-input v-model="dialogConfig.formData.phone" />
        </el-form-item>
        <el-form-item prop="email" required label="邮箱">
          <el-input v-model="dialogConfig.formData.email" />
        </el-form-item>
        <el-form-item prop="email" required label="邮箱">
          <el-input v-model="dialogConfig.formData.email" />
        </el-form-item>
        <el-form-item prop="gender" required label="性别">
          <el-radio-group v-model="dialogConfig.formData.gender">
            <el-radio label="男" border>男</el-radio>
            <el-radio label="女" border>女</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item prop="enabled" required label="状态">
          <el-switch v-model="dialogConfig.formData.enabled"></el-switch>
        </el-form-item>
      </el-form>
      <div class="flex justify-end">
...
import { getUsers, editUsers, addUsers } from "@/api/uc";
